...
| --- | --- | --- | --- | --- | --- | --- |
| crispyx | QC filter | success | 37.52 | 13856.03 | 32255.0 | 23451.0 |
| scanpy | QC filter | success | 11.79 | 4561.7 | 32255.0 | 23451.0 |
| crispyx | pseudobulk (avg log) | success | 28.32 | 4088.86 |  |  |
| crispyx | pseudobulk | success | 25.01 | 3040.66 |  |  |
...
| --- | --- | --- | --- | --- | --- |
| scanpy | t-test | success | 35.7 | 2593.88 | 184 |
| crispyx | t-test | success | 8.01 | 920.42 | 184 |
...
| Package | Method | Status | Total (s) | Memory (MB) | Groups |
| --- | --- | --- | --- | --- | --- |
| crispyx | Wilcoxon | success | 43.57 | 2236.12 | 184 |
| scanpy | Wilcoxon | success | 263.16 | 3632.42 | 184 |
...
| Package | Method | Status | Total (s) | Memory (MB) | Groups |
| --- | --- | --- | --- | --- | --- |
| crispyx | NB-GLM | success | 404.75 | 2243.95 | 184.0 |
| edgeR | NB-GLM | timeout | 3605.11 |  |  |
| pertpy | NB-GLM | error | 2006.88 | 5470.62 |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| QC filter | scanpy QC filter | +25.7s | 318.4% | ❌ | +9294.3 MB | 303.7% | ❌ |
...
| crispyx method | compared to | Time Δ | Time % |  | Mem Δ | Mem % |   |
| --- | --- | --- | --- | --- | --- | --- | --- |
| t-test | scanpy t-test | -27.7s | 22.4% | ✅ | -1673.5 MB | 35.5% | ✅ |
...
| crispyx method | compared to | Time Δ | Time % |  | Mem Δ | Mem % |   |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Wilcoxon | scanpy Wilcoxon | -219.6s | 16.6% | ✅ | -1396.3 MB | 61.6% | ✅ |
